...
/*modified
		- /includes/html/graphs/generic_data.inc.php
			-line 19, 139-150, 156-165
		- /includes/html/graphs/generic_duplex.inc.php
			-line 17, 111-114
*/
$my_template=True;
$my_colours=True;
if($my_colours){
	$colour_area_in = '008000';
	$colour_line_in = '008000';
	$colour_area_out = '0000FF';
	$colour_line_out = '0000FF';
	$colour_area_in_max = '008000';
	$colour_area_out_max = '00000FF';
}
